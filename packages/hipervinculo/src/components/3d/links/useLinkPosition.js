...
const useLinkPosition = (position, rotation, linkPosition) => {
    
    const [addLink, removeLink] = useStore(state => [state.addLink, state.removeLink])
...
export default useLinkPosition;
